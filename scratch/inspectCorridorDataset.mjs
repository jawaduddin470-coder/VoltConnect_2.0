// Diagnostic to inspect actual stations along Hyderabad -> Srinagar in stationsSeed.ts
...
async function inspectCorridor() {
  console.log('=== INSPECTING HYDERABAD -> SRINAGAR CORRIDOR DATASET ===\n');
  ...
  // Let's check bounding box of geometry
...
inspectCorridor().catch(console.error);
