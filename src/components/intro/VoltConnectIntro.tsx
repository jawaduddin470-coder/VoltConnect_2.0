...
export const VoltConnectIntro: React.FC<VoltConnectIntroProps> = ({
  ...
  // Total cinematic timeline duration: 12.5 seconds (10-13s target for continuous one-shot EV ecosystem reveal)
  const TOTAL_DURATION_MS = 12500;
  ...
  useEffect(() => {
    ...
    const animate = (timestamp: number) => {
      ...
      // Quantize progress to ~0.003 step (~37ms) to ensure smooth 60fps performance without React re-render thrashing
